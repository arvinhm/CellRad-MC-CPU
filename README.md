...
This toolkit is compatible with any size of high-dimensional multiplexed images and MERFISH, Xenium, or Visium HD Spatial Transcriptomics (for geometric dosimetry). However, for very large image sizes, we recommend considering using a server cluster to ensure optimal performance.
